        ...
        <View className="flex flex-row flex-wrap justify-between px-5 gap-4">
          ...
          <View className="flex-1 items-center justify-center mt-4">
            <TouchableOpacity
              ...
              className="flex flex-row  gap-2 bg-black py-4 px-8 rounded-lg mx-6"
            >
              <Entypo name={"video-camera"} size={28} color="white" />
              <Text className="ml-3 text-white text-center font-semibold text-lg">
                View Camera
              </Text>
            </TouchableOpacity>
          </View>
