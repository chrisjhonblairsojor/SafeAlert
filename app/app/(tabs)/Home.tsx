...
const IrrigationDashboard = () => {
  ...
  return (
    <SafeAreaView className="flex-1 w-full min -w- full  bg-cyan-400 ">
      ...
      <View className="flex flex-Scol h-aut py-5 mx-5 my-5 bg-white shadow-sm border-b border-gray-100 rounded-lg items-center" onLayout={(event)=>{ setWidth(event.nativeEvent.layout.width);}}>
